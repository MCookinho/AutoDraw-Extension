...
window.AutoDraw.I18n = (() => {
  ...
  const translations = {
    ...
    pt: {
      ...
      tab_logs: 'Logs',
      tooltip_home: 'Inicio',
      tooltip_settings: 'Configuracoes',
      tooltip_mode: 'Modo',
      tooltip_palette: 'Palette',
      tooltip_logs: 'Logs',
      tooltip_theme: 'Tema',
      ...
      status_not_supported: 'Nao suportado:',
      status_no_tab: 'Nenhuma aba ativa',
      status_error_site: 'Erro ao verificar site',
      status_canvas_not_found: 'Canvas nao encontrado. Entre em uma sala de desenho.',
      ...
      color_delay: 'Delay entre cores (ms)',
      anti_aliasing: 'Anti-aliasing',
      auto_start: 'Auto-start',
      language: 'Idioma',

      shortcuts_title: 'Atalhos',
      shortcut_toggle_overlay: 'Trocar overlay',
      shortcut_start_draw: 'Iniciar desenho',
      shortcut_stop_draw: 'Parar desenho',
      shortcut_toggle_decalque: 'Trocar decalque',

      settings_section_title: 'Configuracoes',
      export: 'Exportar',
      import: 'Importar',

      mode_title: 'Modo',
      mode_auto_draw: 'Desenho automatico',
      mode_decalque: 'Decalque',
      decalque_transparency_scale: 'Transparencia e escala',
      opacity: 'Opacidade',
      scale: 'Escala',
      ...
      grayscale: 'Escalinha cinza',
      invert_colors: 'Inverter cores',
      edge_detection: 'Deteccao de contornos',
      ...
      no_palette: 'Nenhuma palette detectada',

      logs_title: 'Logs',
      clear: 'Limpar',
      no_logs: 'Nenhum log ainda',
      settings_imported: 'Configuracoes importadas com sucesso',
    ...
    es: {
      ...
      tab_logs: 'Registros',
      tooltip_home: 'Inicio',
      tooltip_settings: 'Configuracion',
      tooltip_mode: 'Modo',
      ...
      settings_section_title: 'Configuracion',
      export: 'Exportar',
      import: 'Importar',

      mode_title: 'Modo',
      mode_auto_draw: 'Dibujo automatico',
      mode_decalque: 'Calco',
      ...
      edge_detection: 'Deteccion de bordes',
      ...
      clear: 'Limpiar',
      no_logs: 'Sin registros aun',
      settings_imported: 'Configuracion importada con exito',
      ...
      overlay_area_selected: 'Area del lienzo seleccionada',
      overlay_color_picked: 'Color:',
      overlay_minimize: 'Minimizar',
      ...
      alert_no_area: 'Selecciona el area de dibujo.',
