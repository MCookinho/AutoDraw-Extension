...
window.AutoDraw.SketchAdapter = (() => {
  ...
  function init() {
    canvas = findCanvas();
    if (!canvas) {
      console.warn('AutoDraw: Canvas not found on Sketch.io');
      return false;
    }
  ...
  function extractPalette() {
    palette = [];
    const elements = document.querySelectorAll('.palette .color, [class*="color"]');
    elements.forEach(el => {
  ...
  return { init, refresh, extractPalette, setColor, getCanvas, getPalette, isActive, name: 'Sketch.io' };
})();
